...
const PRODUCT_DATA = {
  'النواشف': {
    unit: 'kg',
    products: [
      { name: 'غريبة بندق', price: 40, image: '/images/غريبة بندق.jpeg' },
      { name: 'كعك زهر', price: 30, image: '/images/كعك زهر.jpeg' },
      { name: 'مميلحة عادية', price: 30, image: '/images/مميلحة عادية.jpeg' },
      { name: 'مميلحة تمر', price: 30, image: '/images/مميلحة تمر.jpeg' },
      { name: 'غريبة', price: 35, image: '/images/غريبة.jpeg' },
      { name: 'غريبة طحينية', price: 45, image: '/images/غريبة طحينية.jpeg' },
      { name: 'سمسمية', price: 2.5, unit: 'piece', image: '/images/سمسمية.jpeg' },
      { name: 'غريبة لوز', price: 35, image: '/images/غريبة لوز.jpeg' },
      { name: 'كعك ملون', price: 30, image: '/images/كعك ملون.jpeg' },
      { name: 'مرسيدس', price: 40, image: '/images/مرسيدس.jpeg' },
      { name: 'قرينات لوتس', price: 30, image: '/images/قرينات لوتس.jpeg' },
      { name: 'قرينات كورنفلكس', price: 30, image: '/images/قرينات كورنفلكس.jpeg' },
      { name: 'كعك لوز كاكاو', price: 30, image: '/images/كعك لوز كاكاو.jpeg' },
      { name: 'كعك لوز أبيض', price: 30, image: '/images/كعك لوز أبيض.jpeg' },
      { name: 'كعك معسل', price: 30, image: '/images/كعك معسل.jpeg' },
      { name: 'مقروض طبيعي', price: 1.75, unit: 'piece', image: '/images/مقروض طبيعي.jpeg' },
      { name: 'مقروض عادي', price: 1.5, unit: 'piece', image: '/images/مقروض عادي.jpeg' },
      { name: 'قرينات شوكولاتة', price: 30, image: '/images/قرينات شوكولاتة.jpeg' },
      { name: 'قرينات سكر', price: 30, image: '/images/قرينات سكر.jpeg' },
      { name: 'قرينات لوز', price: 45, image: '/images/قرينات لوز.jpeg' },
      { name: 'أصابع كورنفلكس', price: 30, image: '/images/أصابع كورنفلكس.jpeg' },
      { name: 'غريبة حلقوم', price: 30, image: '/images/غريبة حلقوم.jpeg' },
      { name: 'كعك قرفك', price: 30, image: '/images/كعك قرفك.jpeg' },
    ],
  },
  'الحلويات الشرقية': {
    unit: 'kg',
    products: [
      { name: 'خاتم فستق', price: 80, image: '/images/خاتم فستق.jpeg' },
      { name: 'خاتم لوز', price: 60, image: '/images/خاتم لوز.jpeg' },
      { name: 'رول لوز', price: 60, image: '/images/رول لوز.jpeg' },
      { name: 'رول فستق', price: 80, image: '/images/رول فستق.jpeg' },
      { name: 'أساور كاجو', price: 68, image: '/images/أساور كاجو.jpeg' },
      { name: 'أساور فستق', price: 75, image: '/images/أساور فستق.jpeg' },
      { name: 'أساور لوز', price: 65, image: '/images/أساور لوز.jpeg' },
      { name: 'أصابع لوز كبيرة فردية', price: 60, image: '/images/أصابع لوز كبيرة فردية.jpeg' },
      { name: 'أصابع فستق كبيرة فردية', price: 80, image: '/images/أصابع فستق كبيرة فردية.jpeg' },
      { name: 'أصابع لوز زوجية', price: 60, image: '/images/أصابع لوز زوجية.jpeg' },
      { name: 'أصابع لوز', price: 60, image: '/images/أصابع لوز.jpeg' },
      { name: 'أصابع فستق', price: 80, image: '/images/أصابع فستق.jpeg' },
      { name: 'بقلاوة طرابلسية', price: 100, image: '/images/بقلاوة طرابلسية.jpeg' },
      { name: 'بقلاوة شرقية', price: 75, image: '/images/بقلاوة شرقية.jpeg' },
      { name: 'بقلاوة كاكاوية', price: 45, image: '/images/بقلاوة كاكاوية.jpeg' },
      { name: 'عمبر لوز طرابلسي', price: 55, image: '/images/عبمبر لوز طرابلسي.jpeg  ' },
      { name: 'عمبر مخلط لوز وكاكاوية', price: 40, image: '/images/عمبر مخلط لوز وكاكاوية.jpeg' },
      { name: 'عبمبر جوز الهند', price: 40, image: '/images/عبمبر جوز الهند.jpeg' },
      { name: 'عبمبر لوز معسل', price: 60, image: '/images/عبmpr لوز معسل.jpeg' },
      { name: 'عبمبر بندق معسل', price: 63, image: '/images/عبمبر بندق معسل.jpeg' },
    ],
  },
  'حلويات بالقطعة': {
    unit: 'piece',
    products: [
      { name: 'صدفة لوز', price: 5, image: '/images/صدفة لوز.webp' },
      { name: 'جزرة فستق', price: 6, image: '/images/جزرة فستق.webp' },
      { name: 'كنافة شوكولاتة', price: 4, image: '/images/كنافة شوكولاتة.webp' },
    ],
  },
  'الحافظات': {
    unit: 'box',
    products: [
      { name: 'مقروض طبيعي', price: 20, image: '/images/مقروض طبيعي.jpeg' },
      { name: 'مقروض عادي', price: 17, image: '/images/مقروض عادي.jpeg' },
      { name: 'لويزة شوكولاتة', price: 14, image: '/images/لويزة شوكولاتة.jpeg' },
      { name: 'لويزة لوز', price: 18, image: '/images/لويزة لوز.jpeg' },
      { name: 'لويزة لوتس', price: 16, image: '/images/لويزة لوتس.jpeg ' },
      { name: 'لويزة فستق', price: 19, image: '/images/لويزة فستق.jpeg' },
      { name: 'قرينات كورن فلكس', price: 16, image: '/images/قرينات كورن فلكس.jpeg' },
      { name: 'قرينات كاكاوية', price: 16, image: '/images/قرينات كاكاوية.jpeg' },
      { name: 'قرينات لوتس', price: 17, image: '/images/قرينات لوتس.jpeg' },
      { name: 'قرينات لوز', price: 20, image: '/images/قرينات لوز.jpeg' },
      { name: 'أصابع بريستيج', price: 16, image: '/images/أصابع بريستيج.jpeg' },
      { name: 'سابلي بستاشيو', price: 19, image: '/images/سابلي بستاشيو.jpeg' },
      { name: 'كعك فيريرو', price: 17, image: '/images/كعك فيريرو.jpeg' },
      { name: 'حذوة لوز', price: 17, image: '/images/حذوة لوز.jpeg' },
      { name: 'كعك شوش ورد', price: 16, image: '/images/كعك شوش ورد.jpeg' },
      { name: 'قرينات شوش الورد', price: 17, image: '/images/قرينات شوش الورد.jpeg' },
      { name: 'ميلحة فرارة', price: 15, image: '/images/ميلحة فرارة.jpeg' },
      { name: 'كعك ملبس شوكولاتة', price: 16, image: '/images/كعك ملبس شوكولاتة.jpeg' },
      { name: 'قرينات جوز الهند', price: 16, image: '/images/قرينات جوز الهند.jpeg' },
      { name: 'سابلي مربى', price: 16, image: '/images/سابلي مربى.jpeg' },
      { name: 'غريبة زبيب', price: 15, image: '/images/غريبة زبيب.jpeg' },
      { name: 'كوكيز شوكولاتة', price: 17, image: '/images/كوكيز شوكولاتة.jpeg' },
      { name: 'كوكيز لوز', price: 18, image: '/images/كوكيز لوز.jpeg' },
      { name: 'برازق', price: 18, image: '/images/برازق.jpeg' },
      { name: 'غريبة حمص', price: 15, image: '/images/غريبة حمص.jpeg' },
      { name: 'كوكو برنج', price: 17, image: '/images/كوكو برنج.jpeg' },
      { name: 'مميلحة خزايني', price: 18, image: '/images/مميلحة خزايني.jpeg' },
      { name: 'كعك ملون', price: 15, image: '/images/كعك ملون.jpeg' },
      { name: 'ميلحة شجرة بالزهر', price: 17, image: '/images/ميلحة شجرة بالزهر.jpeg' },
      { name: 'غريبة حلقوم', price: 14, image: '/images/غريبة حلقوم.jpeg' },
      { name: 'بيتيفور', price: 16, image: '/images/بيتيفور.jpeg' },
      { name: 'سابلي خزايني', price: 17, image: '/images/سابلي خزايني.jpeg' },
      { name: 'قرينات نسكافيه', price: 14, image: '/images/قرينات نسكافيه.jpeg' },
      { name: 'أصابع لوتس', price: 18, image: '/images/أصابع لوتس.jpeg' },
      { name: 'غريبة شوكولاتة', price: 15, image: '/images/غريبة شوكولاتة.jpeg' },
      { name: 'أصابع شوكولاتة', price: 19, image: '/images/أصابع شوكولاتة.jpeg' },
      { name: 'كعك لوز شوكولاتة', price: 15, image: '/images/كعك لوز شوكولاتة.jpeg' },
      { name: 'كعك لوز', price: 14, image: '/images/كعك لوز.jpeg' },
      { name: 'مميلحة عصفورة', price: 15, image: '/images/مميلحة عصفورة.jpeg' },
      { name: 'مميلحة فرارة بالتمر', price: 15, image: '/images/مميلحة فرارة بالتمر.jpeg' },
      { name: 'مبرومة', price: 14, image: '/images/مبرومة.jpeg' },
      { name: 'قرينات شوكولاتة', price: 17, image: '/images/قرينات شوكولاتة.jpeg' },
      { name: 'أصابع كورن فلكس', price: 17, image: '/images/أصابع كورن فلكس.jpeg' },
      { name: 'معمول تمر', price: 16, image: '/images/معمول تمر.jpeg' },
      { name: 'حافظة سلة لوز', price: 22, image: '/images/حافظة سلة لوز.jpeg' },
      { name: 'حافظة مشكل بقلاوة', price: 60, image: '/images/حافظة مشكل بقلاوة.jpeg' },
    ],
  },
};
